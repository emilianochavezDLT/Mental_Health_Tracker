...
class JournalEntry(models.Model):
  user = models.ForeignKey(User, on_delete=models.CASCADE) #Links to a specfic user
  date_created = models.DateTimeField(auto_now_add=True) #Date and time of entry
  mood_level = models.IntegerField() # 1 to 5 
  sleep_quality = models.IntegerField() #1 to 5
  excercise_time = models.IntegerField() # in minutes
